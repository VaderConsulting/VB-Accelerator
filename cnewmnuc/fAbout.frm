...
Begin VB.Form frmAbout 
   ...
   Begin VB.CommandButton cmdVBAccel 
      ...
      Width           =   1935
   End
   Begin VB.CommandButton cmdActiveChannel 
      Appearance      =   0  'Flat
      BackColor       =   &H00FFFFFF&
      Height          =   495
      Left            =   960
      Picture         =   "fAbout.frx":05C7
      Style           =   1  'Graphical
      TabIndex        =   8
   ...
   Begin VB.Image imgVBAccelerator 
      Height          =   660
      Left            =   60
      Picture         =   "fAbout.frx":10ED
      Top             =   60
      Width           =   2535
   End
   Begin VB.Label lblDescription 
      BackStyle       =   0  'Transparent
      Caption         =   $"fAbout.frx":1976
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Label lblDescription 
      BackStyle       =   0  'Transparent
      Caption         =   "Welcome to the vbAccelerator Popup Menu Component demonstration."
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
...
Private Sub cmdActiveChannel_Click()
